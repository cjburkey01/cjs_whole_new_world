...
//!
//! Stolen from https://github.com/rparrett/bevy_simple_text_input

// TODO: REPLACE ENTER KEY STUFF WITH A WAY TO QUERY THE TEXT FIELD'S TEXT
...
fn keyboard(
    ...
    mut text_input_query: Query<(Entity, &mut TextValue, &TextInputInactive), With<TextInput>>,
    ...
    for (input_entity, mut text_value, inactive) in &mut text_input_query {
        if inactive.0 {
            continue;
        }
